...
const mnemonic =
  process.env.DEPLOYER_PKY_KEY || 'test test test test test test test test test test test deployer'

const mnemonicBob =
  process.env.BOB_PKY_KEY || 'test test test test test test test test test test test bob'

const mnemonicAlice =
  process.env.ALICE_PKY_KEY || 'test test test test test test test test test test test alice'
