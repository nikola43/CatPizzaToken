...
describe("Token contract", async () => {
    ...
    it("7. Buy Bob", async () => {
        ...
        console.log()
        //--- BUY
        await tokenDeployed.connect(bob).approve(router.address, ethers.constants.MaxUint256);
        await tokenDeployed.connect(bob).approve(tokenDeployed.address, ethers.constants.MaxUint256);
