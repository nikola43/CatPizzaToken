...
interface TestTokenDividendTrackerInterface extends ethers.utils.Interface {
  functions: {
...
export class TestTokenDividendTracker extends BaseContract {
  ...
  interface: TestTokenDividendTrackerInterface;
