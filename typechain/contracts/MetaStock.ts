...
export interface MetaStockInterface extends utils.Interface {
  functions: {
    ...
    "teamWallets(uint256)": FunctionFragment;
    "teamWalletsPercentages(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "teamWallets",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "teamWalletsPercentages",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
...
export interface MetaStock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MetaStockInterface;
